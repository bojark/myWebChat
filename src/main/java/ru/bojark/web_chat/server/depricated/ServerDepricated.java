package ru.bojark.web_chat.server.depricated;
...
public class ServerDepricated {
    ...
    private ServerDepricated(int port, String name, String loggerPath) {
    ...
    public static ServerDepricated buildFormSettings(String settingsPath){
        SettingsParser sp = new SettingsParser(settingsPath);
        return new ServerDepricated(sp.parsePort(), sp.parseUserName(), sp.parseLogPath());
    }
